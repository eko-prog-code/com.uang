...
import { Alert, Dimensions, Modal, StyleSheet, Text, View, Linking } from "react-native";
    ...
    <Modal visible={visible} animationType="fade" transparent>
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          <Gap height={20} />
          <Button  onPress={() => Linking.openURL('https://wa.me/+62895600394345')} title="Hubungi Admin" />

      ...
      <ScrollView style={{ flex: 1 }}>
        <View style={{ marginVertical: 16 }}>
          <View style={{ marginLeft: 20 }}>
            <Text style={{ fontSize: 16, marginBottom: 8 }}>Produk</Text>
          </View>
          <FlatList
        ...
        <View style={{ marginVertical: 16 }}>
          <View style={{ marginLeft: 20 }}>
            <Text style={{ fontSize: 16, marginBottom: 8 }}>Makanan dan Minuman</Text>
          </View>
          <FlatList
            showsHorizontalScrollIndicator={false}
            keyExtractor={(_, index) => index.toString()}
        ...
        <View style={{ marginVertical: 16 }}>
          <View style={{ marginLeft: 20 }}>
            <Text style={{ fontSize: 16, marginBottom: 8 }}>Kosmetik dan Obat</Text>
          </View>
          <FlatList
            showsHorizontalScrollIndicator={false}
            keyExtractor={(_, index) => index.toString()}
